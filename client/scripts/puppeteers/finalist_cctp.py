#!/usr/bin/env python3
"""
Puppeteer for client_cpu_times_puppet.py

Runs a reduced comparison set:
- Pure PQC (128 / 192)
- Hybrid PQC (128 / 192)
...
PUPPET_SCRIPT = "/home/client/pqc/scripts/puppets/client_cpu_times_puppet.py"
...
RESULTS_BASE = "/home/client/pqc/results/cpu_times/full_comparison"


def run_experiment(group, sigalgs, ciphersuite, label):
    """
    Run a single CPU time experiment.
    """

    out_dir = Path(RESULTS_BASE) / label
    out_dir.mkdir(parents=True, exist_ok=True)

    out_csv = out_dir / "cpu_times.csv"
...
def main():
    ...
    print("\n=== Full PQC vs Hybrid vs Classical — Client CPU Time ===")
    ...
    print("\n=== All full-comparison CPU time experiments completed ===")
